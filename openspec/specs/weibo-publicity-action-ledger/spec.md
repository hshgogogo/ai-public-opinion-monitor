# weibo-publicity-action-ledger Specification

## Purpose
Define the Weibo publicity action ledger, source account tracking, user confirmation states, and backtest requirements.
## Requirements
