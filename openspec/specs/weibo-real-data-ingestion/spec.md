# weibo-real-data-ingestion Specification

## Purpose
Define the real Weibo data ingestion path, including environment health, MediaCrawler search/detail tasks, raw archives, and persistence.
## Requirements
