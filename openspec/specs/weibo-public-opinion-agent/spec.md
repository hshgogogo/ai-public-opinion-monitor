# weibo-public-opinion-agent Specification

## Purpose
Define how the Weibo MVP Agent recommends targets, analyzes comments, forms evidence-backed events, and answers from stored memory.
## Requirements
